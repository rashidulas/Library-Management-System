...
public class WordSearch {
    ...
    public void solve() {
        ...
        for (int threadID=0; threadID<NUM_THREADS; ++threadID)
        {
            ...
            final int startPuzzle = (NUM_PUZZLES/NUM_THREADS)*finalThreadID;
            final int endPuzzle = (finalThreadID==NUM_THREADS-1)?NUM_PUZZLES:(NUM_PUZZLES/NUM_THREADS)*(finalThreadID+1);
            threads[finalThreadID]=new Thread(()->{solve(finalThreadID, startPuzzle, endPuzzle);});
    ...
    public void solve(int threadID, int firstPuzzle, int lastPuzzlePlusOne) {
        ...
        List<Solution> threadSolutions = new ArrayList<>();
